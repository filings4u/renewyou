/**
 * ReNew You Health & Wellness - Core Pillars Module (Pillar 02)
 * Location: assets/js/section-3.js
 */
...
function renderCorePillarTwo() {
    ...
    target.innerHTML = `
        ...
        <div style="width: 100%; background-color: #ffffff; padding: 100px 20px; box-sizing: border-box; border-top: 1px solid rgba(138, 52, 159, 0.04); border-bottom: 1px solid rgba(138, 52, 159, 0.04);">
                ...
                <div style="flex: 1; min-width: 400px; padding: 0; text-align: left; box-sizing: border-box;">
                    <div style="max-width: 600px;">
                        ...
                        <h3 style="color: var(--purple-primary); font-size: 2.2rem; font-weight: 800; margin: 0 0 25px 0; letter-spacing: -0.5px; line-height: 1.2;">
                            Frictionless Medical Access
                        </h3>
                        
                        <p style="font-size: 1.15rem; line-height: 1.8; color: #444; margin: 0 0 20px 0;">
                            Modern life is fast and demanding, which means accessing medical care should never feel like an administrative chore or a scheduling conflict. We offer flexible session times designed around busy professional routines and family commitments, minimizing waiting room times to get you seen rapidly.
                        </p>
